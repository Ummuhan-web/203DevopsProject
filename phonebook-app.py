...
def add_record():
    if request.method == 'POST':
        ...
        if phone_number is None or phone_number.strip() == "":
            ...
            return render_template('add-update.html', not_valid=True, message='Invalid input: Phone number should be in numeric format', show_result=False, action_name='save', developer_name='Ummmuhan')
